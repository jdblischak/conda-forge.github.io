...
{{#rerender}}
* The feedstock was rerendered with conda-smithy
{{/rerender}}
{{#update}}
...
{{/reqs_systems_note_flag}}
"
  data <- list(maintainers = c("m1", "m2", "m3"), #paste0("@", old_info$maintainers),
               rerender = rerender,
               update = update,
               reqs_build_lost = reqs_build_lost,
               reqs_build_gained = reqs_build_gained,
               reqs_run_lost = reqs_run_lost,
               reqs_run_gained = reqs_run_gained,
